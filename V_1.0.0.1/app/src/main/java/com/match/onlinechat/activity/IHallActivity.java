...
public class IHallActivity extends AppCompatActivity implements IHallView {
       ...
       /* chatRoomList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(user.getName() == null){
                    Toast.makeText(HallActivity.this,
                            "您未注册！", Toast.LENGTH_SHORT).show();
                    return;
                }
                chatRoomName = adapter.getItem(i);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.signup: {
                if (user.getName() != null) {
                    Toast.makeText(IHallActivity.this, SignupPrompt.MULTIPLE_REGISTRATION,
                            Toast.LENGTH_LONG).show();
                    break;
                }
                startActivity(new Intent(IHallActivity.this, SignupActivity.class));
                break;
            }
            case R.id.newChatRoom: {
                if (user.getName() == null) {
                    Toast.makeText(IHallActivity.this, UserOperationError.UNREGISTERED,
                            Toast.LENGTH_LONG).show();
                    break;
                }
                startActivity(new Intent(IHallActivity.this, NewChatRoomActivity.class));
                break;
            }
            case 0:{
                startActivity(new Intent(IHallActivity.this, ShowUserInfoActivity.class));
                break;
            }
            case 1:{
                ...
                user.setName(null);
                user.setId(10000);
                Toast.makeText(IHallActivity.this, "拜拜了您嘞！",
    ...
    public void setSearch(Menu menu){
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String searchText) {
                ...
                startActivity(new Intent(IHallActivity.this, SearchChatRoomActivity.class));
                return true;
            }
            @Override
    ...
    public void getChatRoom(){
        ...
        TimerTask timerTask = new TimerTask() {
            ...
            public void run() {
                ...
                adapter = new ChatRoomListAdapter(IHallActivity.this,
                        android.R.layout.simple_list_item_1,
                        list, IHallActivity.this);
            }
        };
        //运行
        timer.schedule(timerTask, 0 ,2000); //延迟0秒，间隔2秒循环执行
        IHallActivity.timer = timer;
    }
    ...
    protected void onPause(){
        ...
        IHallActivity.timer.cancel(); //取消定时任务
     ...
     */
    @Override
    public void goChatRoom(String roomName) {
        String chatRoomName;
        //登录检查
        if(user.getName() == null){
            Toast.makeText(IHallActivity.this,
                    "您未注册！", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        controllerHall.selectChatRoom(chatRoomName);
        Intent intent = new Intent();
        intent.setClass(IHallActivity.this, ChatActivity.class);
        //把聊天室名字穿给ChatActivity
        Bundle bundle = new Bundle();
        bundle.putString("chatRoomName", chatRoomName);
        intent.putExtras(bundle);
